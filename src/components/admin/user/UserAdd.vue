    ...
    <div v-loading="loading">
      <el-form :model="userForm" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="name" ref="name">
          <el-input type="text" size="medium" clearable autofocus v-model="userForm.name" placeholder="请输入昵称"
                    @keyup.native="clearValidateInfo('name')">
            <template slot="prepend"><span>昵称&emsp;</span></template>
          </el-input>
        </el-form-item>
        ...
        <el-form-item prop="email" ref="email">
          <el-input type="text" size="medium" clearable v-model="userForm.email" placeholder="请输入电子邮箱地址"
                    @keyup.native="clearValidateInfo('email')">
            <template slot="prepend"><span>邮箱&emsp;</span></template>
          </el-input>
        </el-form-item>

        <el-form-item>
          <el-row>
            <el-button type="primary" style="width: 15rem" @click="addUser">添加用户</el-button>
          </el-row>
        </el-form-item>
      </el-form>
    </div>
